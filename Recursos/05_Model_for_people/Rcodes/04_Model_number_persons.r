...
censo_vivienda <- readRDS("Recursos/05_Model_for_people/Data/01_censo_vivienda_desocupadas.rds") 
...
###############################################################################
# Calculate the total persons per UGM, excluding specific conditions
...
# Fit a Stan GLM model to estimate total population
...
# Calculate the total persons per UGM for occupied households
