...
# Description: Creating the census base with predictions from #
...
# Initialize columns for lower and upper bounds of predicted counts in provinces with complete census
